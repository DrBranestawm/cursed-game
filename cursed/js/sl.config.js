...
{category: "CursedTransformation", effectname: "Lewd Crest", img:"none", desc: "<span style='color:yellow'><em>\"A glowing pink crest with a heart in it's design.\"</em></span><br/><br/><span style='float:right'>As the words form, a slight tingle runs through you, and a crest forms on your abdomen.</span><br/><br/><span style='color:lime'>(Lewd Crest!)</span>",requiresattribnotmin:"gender",requiresattribnotmax:"lewd crest"},
