...
{attribname: "breast size", descs: ["","A-Cup. Tiny, fun sized mounds.","B-Cup. Small and perky.","C-Cup. Round and perky."]},
...
{attribname: "submissiveness", descs: ["","You are naturally submissive, often seeking to obey and please, especially in sexual situations.","You're very submissive, always seeking to obey and please. You get turned on and find it really hard to resist being ordered around.","You need to be told what to do, after all you're an empty headed pet, you'll find yourself falling onto your hands and knees at the slightest commanding tone."]},
...
{attribname: "bondage lover", descs: ["","Restraints such as cuffs and collars turn you on and excite your mind.","Your love for bondage progresses, you need to have some sort of restraining item on you at all times, and when behind closed doors, the more the better."]},
{attribname: "lewd crest", descs: ["","A lewd crest alters your libido and sensitivity."]},
...
{attribname: "breast size", descs:["","Two soft, small mounds form from your chest. You've got boobs!","Your small breasts expand a little more.","Your small breasts expand a little more."]},
...
{attribname: "bondage lover", imgs:["bondage_lover.jpg"]},
{attribname: "lewd crest", imgs:["lewd_crest.jpg"]},
];
...
{category: "CursedTransformation", effectname: "Bondage Lover", img:"none", desc: "<span style='color:yellow'><em>\"Leather and metal, hard they clasp, their restraining attention is long to last!\"</em></span><br/><br/><span style='float:right'>Dolor sit amet, consetetur sadipscing elitr.</span><br/><br/><span style='color:lime'>(Bondage Lover!)</span>",requiresattribnotmin:"gender",requiresattribnotmax:"bondage lover"},
{category: "CursedTransformation", effectname: "Lewd Crest", img:"none", desc: "<span style='color:yellow'><em>\"A succubus charm comes from the crest however on a human, they'll never rest!\"</em></span><br/><br/><span style='float:right'>As the words form, a slight tingle runs through you, and a glowing pink crest with a heart in it's design forms on your abdomen.</span><br/><br/><span style='color:lime'>(Lewd Crest!)</span>",requiresattribnotmin:"gender",requiresattribnotmax:"lewd crest"},
...
"physique":0,
"ass size":0,},
{"name":"Jenny","last name":"Rose","age":20,"height":180,"gender":0,"hair color":"Blonde","eye color":"Blue",
